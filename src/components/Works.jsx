...
const ProjectCard = ({
  ...
  return (
    <motion.div
      ...
      onClick={live_link ? () => window.open(live_link, '_blank', 'noopener,noreferrer') : undefined}
      onKeyDown={live_link ? (e) => { if (e.key === 'Enter' || e.key === ' ') { window.open(live_link, '_blank', 'noopener,noreferrer'); } } : undefined}
        ...
        <div className='relative w-full h-[230px]'>
          ...
          <div className='absolute inset-0 flex justify-end m-3 card-img_hover'>
            <div
              ...
              tabIndex={0}
              onKeyDown={(e) => { e.stopPropagation(); if (e.key === 'Enter' || e.key === ' ') { window.open(source_code_link, '_blank', 'noopener,noreferrer'); } }}
            >
              <img
                src={github}
                alt='source code'
